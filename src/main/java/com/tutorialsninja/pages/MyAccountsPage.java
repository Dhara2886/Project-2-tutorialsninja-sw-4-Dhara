...
public class MyAccountsPage extends Utility {
    ...
    public void enterFirstName() {
        sendTextToElement(firstName, "Dhara");
    }
    ...
    public void enterEMail() {
        ...
        String emailID = "Dhara" + userName + "@gmail.com";
        sendTextToElement(this.emailId, emailID);
    }

    public void enterPhoneNumber() {
        sendTextToElement(mobileNumber, "07525446407");
    }

    public void enterPassword() {
        sendTextToElement(password, "Dhara123");
    }

    public void enterConfirmPassword() {
        sendTextToElement(confirmPassword, "Dhara123");
    }
    ...
    public void enterEmail() {
        sendTextToElement(emailId, "Dhara123@gmail.com");
    }
